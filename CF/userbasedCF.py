...
class UserBasedCF(object):
    ...
    def calc_user_sim(self):
        ...
        for u, related_users in usersim_mat.items():
            #print(u, related_users)
            #print(usersim_mat.items())
    ...
    def evaluate(self):
        ...
        for i, user in enumerate(self.trainset):
            ...
            #if i % 2000 == 0:
             #   rec_movie = self.recommend(user)
              #  print(user)
               # print(rec_movie,file=result)
...
if __name__ == '__main__':
    ratingfile = os.path.join(os.path.abspath(os.getcwd()), 'apk_library2.txt')
    usercf = UserBasedCF()
